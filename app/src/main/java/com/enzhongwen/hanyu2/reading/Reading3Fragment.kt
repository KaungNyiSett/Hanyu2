...
R.id.pinyin_on_off ->{
    if(a == 0){
        ...
        binding.pinyinS1.text = "Zhè zuò shān zhēn gāo a!"
        binding.pinyinS2.text = "Shānshàng de huā zhēn piàoliang a!"
        binding.pinyinS3.text = "Zhè\'er de shuǐguǒ zhēn duō a!"
        binding.pinyinS4.text = "Tā de shūbāo zhēn hǎokàn a!"
        binding.pinyinS5.text = "Jiǎozi zhēn hào chī a!"
        binding.pinyinS6.text = "Zhège yóuxì zhēn hǎowán a!"
        binding.pinyinS7.text = "Zhè shǒu gē zhēn hǎotīng a!"
        binding.pinyinHeading.text = "Wǒmen Zhēn Gāoxìng A"
        binding.pinyinPassage.text = "          Zǎoshang wǒ hé bàba qù páshān, zhè zuò shān zhēn gāo a! Shānshàng de kōngqì hěn hǎo, shù hěnduō, hěn piàoliang. Wǒmen zhēn gāoxìng a!"
        a = 1
    }else{
        a = 0
